...
**Último paso.** Instale un editor de texto para editar tus archivos de código. Para este evento recomendamos el editor de texto Atom o Sublime Text.
...
### *2.* Instala un editor de texto para editar archivos de código
