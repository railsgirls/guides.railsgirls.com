...
Install [Atom](https://github.com/atom/atom/blob/master/README.md#windows) with follow steps.
...
* Run this command. (You might confirm to authorize admin rights on the way to install.)
{% highlight sh %}
cinst Atom
{% endhighlight %}

* You can launch Atom editor with search by the word "atom" on your windows search.
