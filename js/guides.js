...
function initializeOsSwitchers() {
  $(".os-specific").append("<span class='picker'>Escolha seu sistema operacional: <a href='#' class='win-link'>Windows</a> | <a href='#' class='nix-link'>Outro</a></span>").find(".win-link").click(function(event) {
