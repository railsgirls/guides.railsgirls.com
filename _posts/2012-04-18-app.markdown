...
<p><a href="http://www.sublimetext.com">Sublime Text</a>, <a href="http://www.activestate.com/komodo-edit">Komodo Edit</a>, Vim, Emacs, and Gedit sono esempi di editor di testo che puoi utilizzare per scrivere o modificare dei file di testo.</p>

<h3><i class="icon-prompt">&nbsp;</i></h3>

<h3>Terminale (conosciuto anche come Command Prompt in Windows)</h3>
Dove puoi far partire rails server ed eseguire altri comandi.

<h3><i class="icon-browser">&nbsp;</i></h3>

<h3>Web browser</h3>
(Firefox, Safari, Chrome) per vedere la tua applicazione funzionare.
